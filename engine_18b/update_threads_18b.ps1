# update_threads_18b.ps1
# Auto-run benchmark for 18B model, extract recommended numSearchThreads
...
Write-Host "Running benchmark for 18B model, please wait..." -ForegroundColor Cyan
...
Write-Host "Recommended numSearchThreads for 18B = $recommended" -ForegroundColor Green
